...
const Sidebar = () => {
    return (
        <div className='px-6 py-12 bg-base-200 flex flex-col gap-2 border-r-2 border-black min-h-screen'>
            ...
            <Link className='flex items-center gap-2 px-4 py-2 rounded-md hover:bg-slate-500 bg-slate-800 text-white'><GrOverview /> Overview</Link>
            <Link className='flex items-center gap-2 px-4 py-2 rounded-md hover:bg-slate-500 bg-slate-800 text-white'><MdOutlineInventory2 /> My products</Link>
            ...
            <IoHomeOutline />
            Home</Link>
            <button className='flex items-center gap-2 px-4 py-2 rounded-md hover:bg-slate-500 bg-slate-800 text-white'>
            <MdOutlineLogout />
            Logout</button>
        </div>
    );
